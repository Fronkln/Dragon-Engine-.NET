...
CIMGUI_API void ImPlot3D_PlotText(const char* text,float x,float y,float z,float angle,const ImVec2_c pix_offset)
{
...
CIMGUI_API ImVec2_c ImPlot3D_GetPlotPos()
{
    return ConvertFromCPP_ImVec2(ImPlot3D::GetPlotPos());
}
CIMGUI_API ImVec2_c ImPlot3D_GetPlotSize()
{
    return ConvertFromCPP_ImVec2(ImPlot3D::GetPlotSize());
}
...
CIMGUI_API float ImPlot3DPoint_Dot(ImPlot3DPoint* self,const ImPlot3DPoint_c rhs)
{
...
CIMGUI_API ImPlot3DQuat* ImPlot3DQuat_ImPlot3DQuat_FloatPlot3DPoInt(float _angle,const ImPlot3DPoint_c _axis)
{
...
CIMGUI_API ImPlot3DQuat_c ImPlot3DQuat_FromElAz(float elevation,float azimuth)
{
...
CIMGUI_API ImPlot3DQuat_c ImPlot3DQuat_Slerp(const ImPlot3DQuat_c q1,const ImPlot3DQuat_c q2,float t)
{
    return ConvertFromCPP_ImPlot3DQuat(ImPlot3DQuat::Slerp(ConvertToCPP_ImPlot3DQuat(q1),ConvertToCPP_ImPlot3DQuat(q2),t));
}
CIMGUI_API float ImPlot3DQuat_Dot(ImPlot3DQuat* self,const ImPlot3DQuat_c rhs)
{
