...
namespace DragonEngineLibrary
{
    ...
    public unsafe struct BattleFighterInfo
    {
        ...
        [FieldOffset(0x1AF)] public bool is_fly_damage_;
        [FieldOffset(0x1B0)] public bool is_stand_up_;
        [FieldOffset(0x1B1)] public bool is_ready_;
        [FieldOffset(0x1B2)] public bool is_run_end_;
        [FieldOffset(0x1B3)] public bool is_guard_;
        [FieldOffset(0x1B4)] public bool is_guard_reaction_;
        [FieldOffset(0x1B5)] public bool is_sync_;
        [FieldOffset(0x1B6)] public bool is_break_action_;
        [FieldOffset(0x1B7)] public bool is_hide_seek_;
    }
}
