...
namespace DragonEngineLibrary
{
    public static class MarshallingTests
    {
        ...
        [DllImport("Y7Internal.dll", EntryPoint = "LIB_ORBOX_MARSHALTEST", CallingConvention = CallingConvention.Cdecl)]
        public static extern void DELib_Orbox_MarshalTest(IntPtr box);
    }
}
